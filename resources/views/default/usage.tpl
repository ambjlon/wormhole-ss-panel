...
<div class="divcss5-b">
  ...
  <p>首先登录本站进入<a href="/user">用户中心</a>, 再点击进入左侧导航栏的节点列表, 随机选择一台机器点击进入配置详情, 并将配置二维码暴露在屏幕上.</p>
...
<p>2.配置</p>
<p>2(1). 通过扫描二维码完成客户端配置. </p>
<p>首先登录本站进入<a href="/user">用户中心</a>, 再点击进入左侧导航栏的节点列表, 随机选择一台机器点击进入配置详情, 请将配置二维码暴露在屏幕上.</p>
